...
<div class="w3-bar">
	...
	<a class="menu w3-bar-item w3-button w3-hide-small" id="GetFollowedTweets" href=#> FollowedTimeline </a>
...
<div id="stack" class="w3-bar-block w3-theme-d2 w3-hide w3-hide-large w3-hide-medium">
	...
	<a class="menu w3-bar-item w3-button" id="GetFollowedUsers" href=#> Buddies </a>
		<a class="menu w3-bar-item w3-button" id="GetFollowedTweets" href=#> FollowedTimeline </a>
